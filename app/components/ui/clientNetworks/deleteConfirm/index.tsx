...
import { deleteClientNetworkAction } from '@/app/actions/client-networks/deleteClientNetwork'
...
export function DeleteConfirmDialog({
  ...
  const { execute } = useServerAction(deleteClientNetworkAction, {})
  function handleDelete() {
    ...
    execute({ id }).then(([, error]) => {
      ...
      if (error) {
        ...
        setToastAlert({
          open: true,
          message: 'Rede deletada com sucesso',
          variant: 'success',
        })
        onClose()
      }
